...
function AddingRemovingRepositories()
{
    return(
        ...
        <div className="font-inter text-4xl pl-[37px] pt-8">
            <h2 className="term-style-yellow">Adding/Removing Repositories.</h2>
        </div>
        ...
        <div className="font-inter pl-[37px] pt-8 text-[22px] font-[350] tracking-wide leading-10.5 pr-[37px]">
            ...
            <h2 className="pt-8 font-[500] term-style-orange text-3xl pb-6" id="add">{`1)`} Add.</h2>
            <p className="term-style-blue">
            ...
            <h2 className="pt-8 font-[500] term-style-orange text-3xl pb-6" id="remove">{`2)`} Remove.</h2>
            <p className="term-style-blue">
            ...
            <h2 className="pt-8 font-[500] term-style-orange text-3xl pb-6" id="update">{`3)`} Update.</h2>
            <p className="term-style-blue">
            ...
            <h2 className="pt-8 font-[500] term-style-green text-3xl" id="recommended-prac">Recommended practice:</h2>
